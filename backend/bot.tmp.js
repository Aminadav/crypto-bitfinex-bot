...
var funcs=["transfer","force_maker_order","new_order","startBot"]
for(var i=0;i<funcs.length;i++){
    global[funcs[i]]=command(funcs[i])
}

var variables={"side":"buy","wallet":"exchange","amount":"-1","symbol":{"pair":"btcusd","price_precision":5,"initial_margin":"30.0","minimum_margin":"15.0","maximum_order_size":"2000.0","minimum_order_size":"0.004","expiration":"NA"}}
